...
**Sehingga populasi usaha TPT 2023 (cakupan SKIM23) sementara sebesar : `r total_tpt23`** (`r nrow(stpim23_tpt)` STPIM23 TPT + `r nrow(target_imptpt)` Target Imputasi + `r nrow(skim23)` SKIM23).
...
#Populasi TPT
total_tpt23n <- nrow(stpim23_tpt) + nrow(stpim_imptpt) + nrow(skim23)
...
**Jadi populasi usaha TPT 2023 (cakupan SKIM23) menjadi `r total_tpt23n`** (`r nrow(stpim23_tpt)` STPIM23 TPT + `r nrow(stpim_imptpt)` Target Imputasi + `r nrow(skim23)` SKIM23).
