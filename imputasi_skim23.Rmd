...
tab_stpim_imptpt <- stpim_imptpt |>
  ...
  mutate(grwt_inp_imp = ifelse(is.na(grwt_inp), median(grwt_inp, na.rm = TRUE), grwt_inp)) |>   # Adjustment for missing history data
...
#- Komponen biaya input a.l.: bahan baku, BBM,     + listrik?
