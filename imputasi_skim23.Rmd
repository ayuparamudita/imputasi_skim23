...
stpim_imptpt1 <- stpim_imptpt |>
  mutate(Disic5      = ifelse(!(kip %in% cek_kbli_nontpt), b2r217, Disic5),
         kbli2_stpim = ifelse(!(kip %in% cek_kbli_nontpt), kbli2_dpa23, kbli2_stpim))
...
# Menentukan kbli dasar untuk imputasi >> acuan DPA23 karena lebih update dibandingkan data historis STPIM
# Menentukan metod imputasi
