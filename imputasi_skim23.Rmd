...
sisa_target21 <- sisa_target21 |>
  mutate(r203i    = 12,  #bulan operasi
         ...
         #r301b_1i =  0, #upah_tklain
         #r301b_2i =  0, #pengpeklain_tklain
         #r301ci   = rowSums(across(c("r301a_1i", "r301a_2i", "r301b_1i", "r301b_2i")), na.rm = TRUE), #total_upah
        )
```
...
#Combine imputasi bulan operasi dan tk ke dataset utama
stpim_imptpt <- stpim_imptpt |>
  #modif kip tk tidak konsisten
  mutate(r206a = ifelse(kip == 321391986 | kip == 321312025, NA, r206a)) |>
  left_join(imptpt_tk |>
              select(kip, r203i, r206ai, r206b_1i, r206b_2i, r206c_1i, r206c_2i, r206di), by = "kip") |>
...
## Imputasi upah
# upah SKIM23 TL cek konsistensi
# upah sumber STPIM22 21
# upah no histori


### Perbaikan konsistensi upah SKIM23 TL

#Mengecek konsistensi upah dari isian yang respon dengan tenaga kerja. Kemudian melakukan perbaikan isian upah untuk KIP dengan isian upah dan tenaga kerja tidak konsisten.
...
cekskim23tl_upah <- stpim_imptpt |>
  ...
  mutate(cek_upahprod = ifelse((r301a_1 > 0 & r206c_1 > 0), "ok", "inkonsisten"),
